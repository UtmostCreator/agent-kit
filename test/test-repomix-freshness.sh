#!/usr/bin/env bash
# Tests for libexec/repomix-freshness and libexec/repomix-ensure-fresh
...
FRESH="$REPO_ROOT/libexec/repomix-freshness"
ENSURE="$REPO_ROOT/libexec/repomix-ensure-fresh"
...
printf 'repomix-freshness / repomix-ensure-fresh\n'

...
_repomix_try_common_opt() {
    ...
    # `_repomix_shift_count` after this function returns. They are kept because
    # a static introspector's takes-value heuristic can detect value-taking
    # flags by looking for a literal `shift` in the case-branch body; removing

...
This is a Bash-based safety toolkit for coding-agent repository operations. Prefer existing `restsift` commands and shared modules over ad hoc shell logic. Preserve scope checks, execution guards, snapshots, rollback, redaction, machine-readable output, and exit-code contracts.
